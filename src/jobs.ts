...
/**
 * Call Plone's @@downloadtool-updates view with provided data.
 */
export async function downloadtool_updates(data: DownloadToolUpdates) {
  const url = `${PLONE_URL}/@@downloadtool-updates`;
  console.log(`[Worker] Calling ${url} ...`);
